      ...
      <>
         <FormGroup>
            <div>
               ...
               <Input type='text' name='status' placeholder='Enter Status' className='outline-none py-2 pr-4 white block w-full textstyle' value={props.status} onChange={props.handleChange} />
               ...
               <Input type='text' name='targetamount' placeholder='Enter your contact info' className='outline-none py-2 white pr-4 block w-full textstyle' value={props.targetamount} onChange={props.handleChange} />
            </div>
            ...
            <div className='date'>
               ...
               <Input type='date' name='enddate' placeholder='Enter your end date' className='pt-12  white float-left textstyle' value={props.enddate} onChange={props.handleChange} />
            </div>
         </FormGroup>
      </>
   );
