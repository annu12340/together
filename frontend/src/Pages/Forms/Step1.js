      ...
      <>
         <FormGroup>
            ...
            <Input
               ...
               className='outline-none py-2 pr-4 white block w-full textstyle'
               required
            ...
            <textarea name='discription' cols={40} rows={5} placeholder='Enter your Campaign details ' className='outline-none white py-2 pr-4  block w-full textstyle' required value={props.discription} onChange={props.handleChange} />
            ...
            <select name='type' className='outline-none py-2 pr-4 block w-full white textstyle' value={props.type} onChange={props.handleChange}>
               ...
               <option value='Disaster' className='other'>
                  Disaster
               </option>
            </select>
         </FormGroup>
