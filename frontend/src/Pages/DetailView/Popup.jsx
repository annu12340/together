...
//                 overlay.classNameList.toggle('flex')
//             }
...
//                 <svg className="h-6 w-6 cursor-pointer p-1 hover:bg-gray-300 rounded-full" id="close-modal" fill="currentColor" viewBox="0 0 20 20">
...
//                 <button className="px-3 py-1 rounded hover:bg-red-300 hover:bg-opacity-50 hover:text-red-900">Cancel</button>
//                 <button className="px-3 py-1 bg-red-800 text-gray-200 hover:bg-red-600 rounded">Delete</button>
//             </div>
//         </div>
//     </div>
//     </>
